...
public class AccountsTests
{
    ...
    public async Task ConfirmEmailTest()
    {
        ...
        var dbUser = await _dbClient.CreateRoutingDbContext().Users.FirstAsync(x => x.UserName == user.UserName);
    ...
    public async Task RegisterWithEmailTest()
    {
        ...
        await using var routingCtx2 = _dbClient.CreateRoutingDbContext();
        var dbUser = await routingCtx2.Users
    ...
    public async Task RegisterWithoutEmailTest()
    {
        ...
        await using var routingCtx1 = _dbClient.CreateRoutingDbContext();
        var dbUser = await routingCtx1.Users
            .FirstOrDefaultAsync(x => x.UserName == user.UserName);
    ...
    public async Task RegisterWithSameEmailTest()
    {
        ...
        var dbUser1 = await routingCtx.Users.FirstOrDefaultAsync(x => x.UserName == user1.UserName);
        var dbUser2 = await routingCtx.Users.FirstOrDefaultAsync(x => x.UserName == user2.UserName);
